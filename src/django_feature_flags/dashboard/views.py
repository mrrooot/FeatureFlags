...
from django_feature_flags.dashboard.forms import FeatureFlagCreateForm
from django_feature_flags.models import FeatureFlag, Project


@staff_member_required(login_url="/accounts/login/")
def dashboard_home(request):
    flags = FeatureFlag.objects.select_related("project").prefetch_related("states").order_by("-updated_at")[:5]
    context = {
